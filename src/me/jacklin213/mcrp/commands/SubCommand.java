...
public abstract class SubCommand {
    ...
    public static final String NULL_PLAYER = RED + "Player is offline or invalid";
    public static final String NULL_RPCLASS = RED + "Class doesn't exist. To see a list of avalible classes do /class list";
